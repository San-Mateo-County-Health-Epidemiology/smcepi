...
# test orientation ------------------------
## horizontal ----
test_that("theme_smc orientation", {
  theme <- theme_smc(plot_lines = "horizontal")
...
## vertical ----
test_that("theme_smc orientation", {
  theme <- theme_smc(plot_lines = "vertical")
...
## both ----
test_that("theme_smc orientation", {
  theme <- theme_smc(plot_lines = "both")
  expect_equal(class(theme$panel.grid.major.x), c('element_line', 'element'))
  expect_equal(class(theme$panel.grid.major.y), c('element_line', 'element'))
})
...
## none ----
test_that("theme_smc orientation", {
  theme <- theme_smc(plot_lines = "none")
  expect_equal(theme$panel.grid.major.x, element_blank())
  expect_equal(theme$panel.grid.major.y, element_blank())
})

# test legend --------------------------
test_that("theme_smc legend default", {
  theme <- theme_smc()
  expect_equal(theme$legend.position, "top")
})

test_that("theme_smc legend bottom", {
  theme <- theme_smc(legend_loc = "bottom")
