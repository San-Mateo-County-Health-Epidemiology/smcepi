...
# Relative standard error function
...
## Application of the function-Sample

For the sample method, the function inputs include the standard deviation (sd), the sample size (n), and the method ("sample" in this case) to determine the appropriate calculation for the data. The sample method can typically be used on surveillance data sets common in epidemiology. The formula for the `prop_rse` function sample method is $$ prop_rse = \frac{sd}{\sqrt(n)} $$
